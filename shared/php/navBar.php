        ...
        <nav>
            ...
            <aside class="sidebar two">
                <nav>
                    ...
                    <a href="https://lafter.gg/"><button class="hamburger-btn btnText two productBtn productLafter"><span class="brandLafter">L<span class="brandLafterA">a</span>fter</span></button></a>
                </nav>
            </aside>
            ...
            <aside class="sidebar two">
                <nav>
                    <a href="https://gaming.gangdev.co/gameEngine"><button class="hamburger-btn btnText two">Game Engine<br> <b style="color: #7de6ff;">(Alpha)</b> </button> </a>
                    <a href="https://gaming.gangdev.co/basicFighterGame" target="_blank"><button class="hamburger-btn btnText two">Fighting Game<br> <b style="color: #7de6ff;">(Beta)</b> </button> </a>
                    <a href="https://crust.gangdev.co/game1" target="_blank"><button class="hamburger-btn btnText two">Crust<br> <b style="color: #7de6ff;">(Alpha)</b> <b style="color: lightgreen;">[Online]</b> </button> </a>
                    <a href="https://apps.gangdev.co/web/roastGenerator"><button class="hamburger-btn btnText two">Roast Generator<br> <b style="color: #7de6ff;">(Alpha)</b> </button> </a>
                    <a href="https://apps.gangdev.co/web/mmfGenerator"><button class="hamburger-btn btnText two">MMF Generator<br> <b style="color: #7de6ff;">(Beta)</b> </button> </a>
                </nav>
            </aside>
