        ...
        <nav>
            ...
            <aside class="sidebar two">
                <nav>
                    ...
                    <a href="https://gaming.gangdev.co/game2" target="_blank"><button class="hamburger-btn btnText two">Multiplayer Game<br>(Alpha) <b style="color: lightgreen;">[Online]</b></button></a>
